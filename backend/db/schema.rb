...
ActiveRecord::Schema[8.1].define(version: 2026_07_19_140000) do
  ...
  create_table "access_rules", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
  ...
  create_table "folder_owners", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "folder_path", null: false, collation: "utf8mb4_bin"
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
  ...
  create_table "share_links", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "token", null: false, collation: "utf8mb4_bin"
    t.datetime "updated_at", null: false
